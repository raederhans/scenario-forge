# QA-049 — 剧本模式下母国-可释放国家 UI 交互与菜单组件审查
...
**Prerequisite:** QA-046 已识别分组退化、预设失联、inspector 空态等基础问题。本报告聚焦其上层——交互流与状态一致性
...
QA-046 已确认"剧本数据能载入、地图能切色"的最低可用性。本报告进一步审查剧本模式下**母国与可释放国家之间的交互循环**，包括：列表展开/折叠、Inspector 导航、颜色修改、主权切换、预设应用、搜索行为。
