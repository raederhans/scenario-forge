...
export const UI_COPY_CATALOG = Object.freeze({
  ...
  "Experimental layer catalog": { zh: "实验图层目录", en: "Experimental layer catalog" },
  "City hierarchy": {"zh": "城市层级", "en": "City hierarchy"},
  "Metropolis": {"zh": "大都会", "en": "Metropolis"},
  "Large city": {"zh": "大型城市", "en": "Large city"},
  "Medium city": {"zh": "中型城市", "en": "Medium city"},
  "Small city": {"zh": "小城", "en": "Small city"},
  "Town": {"zh": "小镇", "en": "Town"},
  "Map detail": {"zh": "地图详细程度", "en": "Map detail"},
  "Compact": {"zh": "简洁", "en": "Compact"},
  "Standard": {"zh": "标准", "en": "Standard"},
  "Detailed": {"zh": "详细", "en": "Detailed"},
  "Smallest settlements shown": {"zh": "最低显示等级", "en": "Smallest settlements shown"},
  "Scenario strategic data": {"zh": "剧本战略数据", "en": "Scenario strategic data"},
  "Load data": {"zh": "加载数据", "en": "Load data"},
  "Region shading": {"zh": "区域着色", "en": "Region shading"},
  "Resource type": {"zh": "资源种类", "en": "Resource type"},
  "Color scale": {"zh": "色带", "en": "Color scale"},
  "Shading opacity": {"zh": "着色透明度", "en": "Shading opacity"},
  "Inspect region values": {"zh": "查看区域数值", "en": "Inspect region values"},
  "Source region": {"zh": "来源区域", "en": "Source region"},
