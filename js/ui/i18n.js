...
function updateUIText() {
  const uiMap = [
    ...
    ["countryInspectorEmptyHint", "Choose a country above, then use Set Active and the Territories & Presets panel."],
    ...
    ["scenarioContextModeText", "Mode: Visual"],
    ...
    ["scenarioGuideStepActive", "Set Active for sovereignty actions"],
    ["scenarioGuideStepApplyActions", "Apply Core Territory or presets in Territories & Presets"],
  ];
