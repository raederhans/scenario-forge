...
function updateUIText() {
  ...
  const uiMap = [
    ...
    ["lblOceanAdvancedStylesToggle", "Experimental Ocean Styles"],
    ["oceanAdvancedStylesHint", "Enable bathymetry and wave presets for testing. May reduce pan and zoom performance."],
    ["lblOceanStyle", "Style"],
