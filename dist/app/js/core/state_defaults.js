...
function normalizeCityLayerStyleConfig(rawConfig) {
  ...
  return {
    ...
    densityPreset: ["compact", "balanced", "detailed"].includes(raw.densityPreset) ? raw.densityPreset : defaults.densityPreset,
    minSettlementRank: ["metropolis", "large", "medium", "small", "town"].includes(raw.minSettlementRank) ? raw.minSettlementRank : defaults.minSettlementRank,
