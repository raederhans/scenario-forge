...
against this checkout and passes strict/LOD checks. HGO and blank now have full
historical bundles with strict passes. The first 12-country Europe candidate was
rejected for surface drift; AL/MK 20 targets pass the geometry gate. Fresh JP
...
unchanged and performance acceptance is still open.
