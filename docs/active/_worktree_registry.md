...
| 当前入口 | 用途与边界 |
| --- | --- |
| `C:/Users/raede/Desktop/dev/mapcreator` | 主工作区，本次城市／战略面板与剧本颜色整合使用 `codex/city-strategic-colors-20260923`，基于已合并 PR #149 的 `origin/main`。交付见 [PR #150](https://github.com/raederhans/scenario-forge/pull/150)；当前 SHA、CI、合并与自动部署状态以 Git / GitHub 回执为准。保留既有未跟踪 `.playwright-mcp/`。 |
