...
| 当前入口 | 用途与边界 |
| --- | --- |
| `C:/Users/raede/Desktop/dev/mapcreator` | 主工作区，本次湖泊填色与海水联动使用 `codex/water-fill-continuity-20260923`，基于已合并 PR #150 的 `origin/main`。交付见 [湖泊修复任务](water-fill-continuity-20260923/task.md)；当前 SHA、CI、合并与自动部署状态以 Git / GitHub 回执为准。保留既有未跟踪 `.playwright-mcp/`。 |
