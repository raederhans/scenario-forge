...
class MapRendererRenderCacheOwnerBoundaryContractTest(unittest.TestCase):
    def test_map_renderer_keeps_cache_facade_while_render_cache_owner_holds_canvas_and_signature_state(self):
        ...
        self.assertIn("function composeRenderCacheValidationScope(state, ensure)", owner_content)
        ...
        self.assertIn("() => ensureRenderPassCacheState(state, { cloneZoomTransform, renderPassNames }),", owner_content)
