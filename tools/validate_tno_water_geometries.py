...
TRACKED_COVERAGE_PROBES = [
    ...
    # Use water interiors outside the authoritative physical land mask. The former
    # coastal points remain land-exclusion probes in water_geometry_runtime.test.mjs.
