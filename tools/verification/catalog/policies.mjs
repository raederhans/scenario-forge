    ...
    "heavyDependencyGroups": [
      {
        ...
        "patterns": [
          "tests/test_france_lod_contract.py",
          "tests/test_france_precision.py",
          "tests/test_france_topology_precision.py",
          "tests/test_extension_admin1_coverage.py",
          "tests/test_regional_basic_processors.py",
          "tests/test_regional_boundary_alignment.py",
          "tests/test_regional_geometry.py",
          "tests/test_regional_precision_lod.py",
          "tests/test_regional_processors.py",
          "tests/test_regional_rebuild_plan.py",
          "tests/test_regional_scenario_assets.py",
          "tests/test_scenario_spatial_chunk_assets.py",
          "tests/test_scenario_surface_constraints.py",
          "tests/test_source_coverage_repair.py",
          "tests/test_tno_regional_precision.py",
          ...
          "tests/test_marine_refinement.py",
