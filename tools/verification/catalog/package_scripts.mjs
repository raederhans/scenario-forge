...
export const PACKAGE_SCRIPTS = {
    "test:node:display-quality-policy": "node --test tests/display_quality_policy_behavior.test.mjs",
    "test:node:political-border-assets": "node --test tests/political_border_assets_behavior.test.mjs",
    "test:node:political-border-policy": "node --test tests/political_border_policy_behavior.test.mjs",
    "test:node:political-border-runtime": "node --test tests/political_border_runtime_behavior.test.mjs",
    "test:node:scenario-border-pack-loading": "node --test tests/scenario_border_pack_loading_behavior.test.mjs",
    "test:node:scenario-display-profile": "node --test tests/scenario_display_profile_behavior.test.mjs",
    "test:python:source-coverage-repair": "npm run python -- -m unittest tests.test_source_coverage_repair -q",
    "test:python:extension-admin1-coverage": "npm run python -- -m pytest tests/test_extension_admin1_coverage.py -q",
    "test:python:tno-border-continuity": "npm run python -- -m unittest tests.test_tno_border_continuity -q",
    "test:e2e:map-clarity": "node tools/e2e_layering.mjs run-spec tests/e2e/map_clarity.spec.js",
    "test:node:ownership-retirement": "node --test tests/map_data_boundary_behavior.test.mjs tests/ownership_retirement_behavior.test.mjs tests/dev_workspace_selection_ownership_behavior.test.mjs tests/scenario_import_trust_projection_behavior.test.mjs tests/quick_fill_hierarchy.test.mjs tests/scenario_state_actions_atomicity_behavior.test.mjs tests/click_selection_transaction_owner_behavior.test.mjs tests/history_feature_color_refresh_behavior.test.mjs tests/atlantropa_water_color_behavior.test.mjs tests/toolbar_render_scheduler_behavior.test.mjs tests/reference_consumer_retirement.test.mjs tests/border_mesh_owner_behavior.test.mjs tests/border_draw_owner_behavior.test.mjs tests/palette_library_operation_behavior.test.mjs tests/palette_library_operation_boundary.test.mjs tests/parent_border_grouping_policy_behavior.test.mjs tests/fill_target_policy_behavior.test.mjs tests/brush_interaction_session_owner_behavior.test.mjs tests/visual_brush_transaction_behavior.test.mjs tests/scenario_hierarchy_behavior.test.mjs tests/legend_manager_generation_behavior.test.mjs tests/paint_contour_graph_behavior.test.mjs tests/paint_contour_runtime_behavior.test.mjs tests/render_pass_signature_policy_behavior.test.mjs",
    ...
    "test:node:startup-lifecycle": "node --test tests/startup_ready_handoff_behavior.test.mjs tests/startup_data_pipeline_lifecycle_behavior.test.mjs tests/startup_interaction_lifecycle_behavior.test.mjs",
    "test:node:project-import-lifecycle": "node --test tests/project_import_completion_behavior.test.mjs tests/project_package_stream_import_behavior.test.mjs tests/scenario_import_trust_projection_behavior.test.mjs tests/scenario_project_import_recovery_behavior.test.mjs",
    ...
    "test:node:renderer-editing": "node --test tests/operation_graphics_editor_render_owner_behavior.test.mjs tests/physical_intensity_interaction_owner_behavior.test.mjs tests/strategic_overlay_helpers_behavior.test.mjs",
    "test:node:renderer-lifecycles": "node --test tests/political_path_cache_owner_behavior.test.mjs tests/brush_interaction_session_owner_behavior.test.mjs tests/static_border_mesh_lifecycle_behavior.test.mjs tests/physical_intensity_preview_owner_behavior.test.mjs",
    "test:node:renderer-splits": "node --test tests/city_label_text_model_behavior.test.mjs tests/urban_adaptive_paint_model_behavior.test.mjs tests/political_feature_policy_behavior.test.mjs tests/scenario_region_overlay_render_owner_behavior.test.mjs tests/transient_overlay_render_owner_behavior.test.mjs tests/unit_counter_display_model_behavior.test.mjs tests/operation_graphic_geometry_behavior.test.mjs tests/strategic_overlay_runtime_owner_behavior.test.mjs tests/strategic_overlay_render_owner_behavior.test.mjs tests/retired_frontline_behavior.test.mjs tests/strategic_overlay_state_behavior.test.mjs tests/special_zone_layers_state_behavior.test.mjs tests/special_zones_workbench_controller_behavior.test.mjs tests/scenario_optional_layers_behavior.test.mjs",
    ...
    "test:node:render-transaction-diagnostics": "node --test tests/render_transaction_diagnostics_behavior.test.mjs tests/renderer_transaction_diagnostics_actions_behavior.test.mjs",
    ...
    "test:e2e:physical-layer-runtime-contract": "node tools/e2e_layering.mjs run-spec tests/e2e/physical_layer_runtime_contract.spec.js",
    ...
    "test:e2e:tno-contracts": "node tools/e2e_layering.mjs run-spec tests/e2e/tno_startup_visible_context_layers_contract.spec.js && node tools/e2e_layering.mjs run-spec tests/e2e/tno_1962_ui_smoke.spec.js",
