...
export function createLocalFeedbackRecords(baseRecords) {
  ...
  const localOwnerCoverage = [
    ...
    ["light-texture-tile-cache", "renderer-runtime", "js/core/renderer/light_texture_tile_cache.js", "tests/light_texture_tile_cache_behavior.test.mjs"],
    ["night-source-metrics", "renderer-runtime", "js/core/renderer/source_metrics_cache.js", "tests/source_metrics_cache_behavior.test.mjs"],
    ["city-support-loading", "city-runtime", "js/core/state/content_state.js", "tests/city_support_loading_behavior.test.mjs", ["js/core/data_loader.js", "js/bootstrap/startup_data_pipeline.js"]],
    ["day-night-mask", "renderer-runtime", "js/core/renderer/day_night_mask.js", "tests/day_night_runtime_owner_behavior.test.mjs"],
