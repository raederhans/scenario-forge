...
DEFAULT_MANUAL_UI_DICT = {
    ...
    "Road and rail are the only Japan families with detailed controls right now. This family keeps only its reserved shell.": "当前只有道路和铁路这两个日本家族具备详细控件。这个家族目前只保留预留外壳。",
    "Sample": "样本",
    ...
    "Drag rows to define the future draw order. Only the road family is live right now, so the rest stay as structural placeholders.": "拖动各行来定义未来的绘制顺序。当前只有道路家族已接入，其他仍作为结构占位。",
    "Enabled": "已启用",
    "Label shell": "标签外壳",
    ...
    "Use the center board to sort the seven transport families. Left stays as context only, while the right deck owns all tuning.": "使用中间面板对七个运输家族排序。左侧只保留上下文，右侧面板负责全部调节。",
    ...
    "Derived frontlines stay optional and project-local. Enable them only when you want a conflict view.": "派生前线保持为可选且仅限当前项目。只有在需要冲突视图时再启用。",
    "Warmth": "暖色度",
    "Wasteland Fill": "荒地填充",
