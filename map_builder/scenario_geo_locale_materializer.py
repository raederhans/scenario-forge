...
def _run_legacy_geo_locale_builder(
    ...
    *,
    ...
    return {
        "publishedPaths": [str(context["geoLocalePatchPath"])],
...
def materialize_scenario_geo_locale(
    ...
    *,
    ...
    if scenario_id == "tno_1962":
        ...
        return {
            "checkpointPaths": [
                str(resolved_checkpoint_dir / tno_bundle.CHECKPOINT_RUNTIME_BOOTSTRAP_TOPOLOGY_FILENAME),
                str(resolved_checkpoint_dir / tno_bundle.CHECKPOINT_GEO_LOCALE_FILENAME),
                str(resolved_checkpoint_dir / tno_bundle.CHECKPOINT_GEO_LOCALE_EN_FILENAME),
                str(resolved_checkpoint_dir / tno_bundle.CHECKPOINT_GEO_LOCALE_ZH_FILENAME),
                str(resolved_checkpoint_dir / tno_bundle.CHECKPOINT_STARTUP_BUNDLE_EN_FILENAME),
                str(resolved_checkpoint_dir / tno_bundle.CHECKPOINT_STARTUP_BUNDLE_ZH_FILENAME),
            ],
    ...
    return _run_legacy_geo_locale_builder(
        context,
        root=root,
